      ...
      <div>
        <form @keyup.enter="signin">
          <div class="sign_input_g">
            <el-input placeholder="用户名*" type="text" @input="changeName" @blur.stop.prevent="checkName" v-model="userName" class="mar_t"></el-input>
            <span>
              <i :class="errorMsgClass" class="animated" v-if="verify._userName">{{verify.userName}}</i>
            </span>
          </div>
          <div class="sign_input_g">
            <el-input placeholder="昵称" type="text" v-model="nickName" class="mar_t"></el-input>
            <span>
              <i :class="errorMsgClass" class="animated" v-if="false"></i>
            </span>
          </div>
          <div class="sign_input_g">
            <el-input placeholder="密码*" type="password" @input="changePassword" @blur="changePassword" v-model="password" class="mar_t"></el-input>
            <span>
              <i :class="errorMsgClass" class="animated" v-if="verify._pwd">{{verify.pwd}}</i>
            </span>
          </div>
          <div class="sign_input_g">
            <el-input placeholder="确认密码*" type="password" @input="changeConfirmPwd" @blur="changeConfirmPwd" v-model="confirmPass" class="mar_t"></el-input>
            <span>
              <i :class="errorMsgClass" class="animated" v-if="verify._confirmPwd">{{verify.confirmPwd}}</i>
            </span>
          </div>
          <div class="mar_t">
